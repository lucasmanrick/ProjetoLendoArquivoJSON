...
export default function App() {
  ...
  const [clientRegister, setClientRegister] = useState (null);
    ...
    <View style={styles.container}>
      <View style={styles.containerLargura}>
        ...
        {dados ? dados.map((el) => ( 
          ...
          <TextInput style={styles.textInput} value={el.nome} />

          <Text style={styles.titleInfo}>Data de Nasc.:</Text>
          <TextInput style={styles.textInput} value={el.data_nasc} />

          <Text style={styles.titleInfo}>E-mail:</Text>
          <TextInput style={styles.textInput} value={el.email} />

          <Text style={styles.titleInfo}>Telefone:</Text>
          <TextInput style={styles.textInput} value={el.telefone} />
        </View>
        )) : (
